...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libamd,
        "lib/libamd.3.2.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libbtf,
        "lib/libbtf.2.2.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libcamd,
        "lib/libcamd.3.2.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libccolamd,
        "lib/libccolamd.3.2.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
    ...
    JLLWrappers.@init_library_product(
        libldl,
        "lib/libldl.3.2.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        librbio,
        "lib/librbio.4.2.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
