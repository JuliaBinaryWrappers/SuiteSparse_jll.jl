# Autogenerated wrapper script for SuiteSparse_jll for x86_64-linux-gnu-sanitize+memory
...
JLLWrappers.@declare_library_product(libcholmod, "libcholmod.so.4")
...
JLLWrappers.@declare_library_product(librbio, "librbio.so.3")
JLLWrappers.@declare_library_product(libspqr, "libspqr.so.3")
