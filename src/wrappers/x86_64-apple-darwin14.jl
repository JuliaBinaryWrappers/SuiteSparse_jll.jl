...
export libsuitesparse_wrapper, libspqr, libsuitesparseconfig, libamd, libccolamd, libcholmod, libcamd, libumfpack, libcolamd
...
const libspqr_splitpath = ["lib", "libspqr.dylib"]
...
const libsuitesparseconfig_splitpath = ["lib", "libsuitesparseconfig.dylib"]
...
const libamd_splitpath = ["lib", "libamd.dylib"]
...
const libccolamd_splitpath = ["lib", "libccolamd.dylib"]
...
const libcholmod_splitpath = ["lib", "libcholmod.dylib"]
...
const libcamd_splitpath = ["lib", "libcamd.dylib"]
...
const libumfpack_splitpath = ["lib", "libumfpack.dylib"]
...
const libcolamd_splitpath = ["lib", "libcolamd.dylib"]
