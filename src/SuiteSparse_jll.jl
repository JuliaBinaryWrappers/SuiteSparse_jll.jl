...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SuiteSparse_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("bea87d4a-7f5b-5778-9afe-8cc45184846c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SuiteSparse", artifacts_toml) for e in artifacts["SuiteSparse"]]
...
if best_platform === nothing
    @debug("Unable to load SuiteSparse; unsupported platform $(triplet(platform_key_abi()))")
else
